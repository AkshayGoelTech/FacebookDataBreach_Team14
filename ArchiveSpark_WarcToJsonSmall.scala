...
val warcPath = "/user/cs4984cs5984f18_team14/14_Facebook_Breach_small/"
val cdxPath = "/user/cs4984cs5984f18_team14/14_Facebook_Breach_small/*.cdx"
...
result_df.repartition(1).write.mode("overwrite").format("json").save("/user/cs4984cs5984f18_team14/14_Facebook_Breach_small/articlehtml") // export data to your local path